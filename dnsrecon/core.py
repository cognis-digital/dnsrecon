"""DNSRECON core — Aggregate DNS recon (records, zone hints, takeover candidates)."""
...
RULES = [
    ("DNS-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("DNS-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("DNS-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
