...
[![PyPI](https://img.shields.io/pypi/v/cognis-dnsrecon.svg)](https://pypi.org/project/cognis-dnsrecon/)
[![CI](https://github.com/cognis-digital/dnsrecon/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/dnsrecon/actions)
...
DNSRECON exists for one job — aggregate dns recon (records, zone hints, takeover candidates) — and does it without a SaaS bill or heavyweight setup.
...
```bash
dnsrecon --version
dnsrecon scan .                      # scan the current project
dnsrecon scan . --format json
dnsrecon scan . --fail-on high       # non-zero exit for CI gates
dnsrecon mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **dnsrecon**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`dnsrecon` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
