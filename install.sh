#!/usr/bin/env sh
# Universal installer for dnsrecon. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/dnsrecon.git"
